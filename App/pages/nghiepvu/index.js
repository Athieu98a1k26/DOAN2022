...
import api from "../../api/nghiepvuapi";
...
const App = () => {
    ...
    const handleOk = (edit) => {
        // onFinish()
        if (edit) {
            api.suanghiepvu({ ...state, bienChe: true }).then(d => {
                console.log(d, "đ")
            ...
            api.sendnghiepvu({ tenNghiepVU: state.tenNghiepVU, ghiChu: state.ghiChu, bienChe: true }).then(d => {
                console.log(d, "đ")
        ...
        <div className='content' style={{ marginTop: 50 }}>
            ...
            <Modal
                ...
                >
                    ...
                    >
                        <Input defaultValue={state?.tenNghiepVU} name="tenNghiepVU" onChange={onChange} />
                    </Form.Item>
                    <Form.Item
                        label="Ghi chú"
                        name="ghichu"
