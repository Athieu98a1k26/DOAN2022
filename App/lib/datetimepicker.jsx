...
/**
* @extends {React.Component<{...TextField.propTypes, options:object, onChange:Function.isRequired, onOpen:Function, onClose:Function, onMonthChange:Function, onYearChange:Function, onReady:Function, onValueUpdate:Function, onDayCreate:Function, enableTime:boolean, jumpToDate:any, buttons:arrayOf(oneOf(["month", "all", "week", "date", "today", "prevDay", "nextDay", "prevMonth", "nextMonth", "currentMonth", "nextWeek", "currentWeek", "prevWeek", "clear"])), excludedButtons:arrayOf(oneOf(["month", "all", "week", "date", "today", "prevDay", "nextDay", "prevMonth", "nextMonth", "currentMonth", "nextWeek", "currentWeek", "prevWeek"])), value:oneOfType([string, array, object, number]), className:string, labelWarning:string, //labelnằmdướiinput(nhằmcảnhbáo, nhắcnhở)}>}
*/
class DateTimePicker extends Component {
    ...
    render() {
        const { options, onChange, value, excludedButtons, buttons, labelWarning, jumpToDate, ...props } = this.props
