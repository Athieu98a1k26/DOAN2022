...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rws.Models.TblDaoTao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Rws.Models.TblGiangVien", b =>
                {
                    ...
                    b.Property<byte?>("KetQuaThiDua")
                        .HasColumnType("tinyint");

                    b.Property<byte?>("KhenThuong")
                        .HasColumnType("tinyint");

                    b.Property<int>("KhoaDaoTao")
                        .HasColumnType("int");

                    b.Property<byte?>("KieuGV")
                        .HasColumnType("tinyint");

                    b.Property<byte?>("LoaiGiangVien")
                        .HasColumnType("tinyint");

                    b.Property<byte?>("LoaiVienChuc")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("Rws.Models.TblKhoaDaoTao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Rws.Models.TblSinhVien", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Rws.Models.TblGiangVien", b =>
                {
                    ...
                    b.HasOne("Rws.Models.TblDaoTao", "DaoTao")
                        .WithMany()
                    ...
                    b.HasOne("Rws.Models.TblPhongBan", "TblPhongBan")
                        .WithMany()
                        .HasForeignKey("TblPhongBanId");
                });
            ...
            modelBuilder.Entity("Rws.Models.TblSinhVien", b =>
                {
                    ...
                    b.HasOne("Rws.Models.TblKhoaDaoTao", "KhoaDaoTao")
                        .WithMany("SinhVien")
