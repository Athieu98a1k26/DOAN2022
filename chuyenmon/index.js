...
const App = () => {
    ...
    const handleOk = (edit) => {
        ...
        if (edit) {
            ...
            api.sendchuyenmon({ ...state, bienChe: true }).then(d => {
                console.log(d, "đ")
        ...
        <div className='content' style={{ marginTop: 50 }}>
            ...
            <Modal
                ...
                >
                    ...
                    >
                        <Input defaultValue={state?.chuyenNganh} name="chuyenNganh" onChange={onChange} />
                    </Form.Item>
                    <Form.Item
                        label="Năm TN"
                        name="namtn"
                    ...
                    >
                        <DatePicker defaultValue={moment(state?.namTN)} name="namTN" picker="year" onChange={(e) => handleChange(e, "namHoc")} />
                    </Form.Item>
                    <Form.Item
                        label="Nơi TN"
                        name="noitn"
