...
export default function PaymentSelectedCard15({ LANG }) {
  ...
  const addDatabaseCreditCard = (data, typeCard) => {
    ...
    transactionApi.addTransactionCreditCard({
      ...
      CardNumber,
      amount: amountFirst,
      PaymentMethodId: getTypeCard(typeCard, true),
      LevyId,
      status: 1,
      LevyType: LevyId,
  ...
  const creditCardSuccessTransaction = (
    data,
    dateExpire,
    dateTransaction,
    typeCard
    ...
    addDatabaseCreditCard(data, typeCard);
